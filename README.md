...
The [four concept files](concepts/Lax678846) define finite structures,
ordinary existential second-order syntax, the standard polynomial-certificate
machine definition of NP, and [Fagin’s theorem](concepts/Lax678846/Fagin.lean).
...
For [∃SO → NP](proofs/Lax678846Proofs/DefinableInNP.lean), the machine guesses
...
For [NP → ∃SO](proofs/Lax678846Proofs/NPDefinable.lean), two guessed relations
...
The local [concepts preview](http://localhost:8126/lax-678846/index.html) is
