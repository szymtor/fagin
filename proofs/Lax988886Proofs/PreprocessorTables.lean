...
namespace Lax988886Proofs.PreprocessorTables
...
theorem program_executes {σ : Vocabulary} {k : Nat} {p : Polynomial Nat}
  ...
  have hvt : ∀ r, v.stk (table σ k p r) =
      (Lax751879.StructureEncoding.tuples B.size ((k :: k :: σ).get r)).map (B.relation r) := by
    intro r
...
end Lax988886Proofs.PreprocessorTables
