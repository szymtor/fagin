...
namespace Lax988886Proofs.RelationalVerifier
...
theorem language_encode_iff {σ : Vocabulary} (Q : Property σ) (A : Structure σ) :
  ...
  constructor
  · rintro ⟨B, hB, hQ⟩
    have he : (⟨B, Fin.elim0⟩ : Lax751879.OrderedStructures.PointedStructure σ 0) = ⟨A, Fin.elim0⟩ :=
...
end Lax988886Proofs.RelationalVerifier
