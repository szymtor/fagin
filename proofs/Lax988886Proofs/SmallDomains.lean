...
namespace Lax988886Proofs.SmallDomains
...
open Lax751879Proofs.FiniteExceptions Lax751879Proofs.AddressFormulas
open Lax988886Proofs.OrderedFirstOrder

theorem bounded_firstOrder {σ : Vocabulary} (Q : Property σ) (N : Nat) :
    FirstOrder (boundedFormula (fun A : Lax751879.OrderedStructures.PointedStructure σ 0 =>
...
end Lax988886Proofs.SmallDomains
