...
namespace Lax988886Proofs.GuardedVerifier
...
theorem program_executes (h : TM2ComputableInPolyTime ea (fun b => [b]) V) (a : Bool × α) :
  ...
  have hmono := Lax751879Proofs.PolynomialBounds.eval_mono (TMComputable.costPolynomial h.tm h.time)
...
end Lax988886Proofs.GuardedVerifier
