...
namespace Lax678846Proofs.VerifierEvaluation
...
theorem dense_tables {τ : Vocabulary} {n : Nat} (R : Interpretation τ n) (r : Symbol τ) :
    DenseTables.dense (FirstOrderEvaluation.tables R r) =
      (Lax979537.StructureEncoding.tuples n (τ.get r)).map (R r) := by
...
theorem represents (φ : Sentence σ) (w c : List Bool)
    (A : Lax979537.OrderedStructures.PointedStructure σ 0)
  ...
  have hw : Decoding.decode φ.witnesses 0
      (Lax979537.StructureEncoding.unary A.structureValue.size ++ c) =
...
end Lax678846Proofs.VerifierEvaluation
