...
namespace Lax678846Proofs.StackConcat
...
def copy (out tmp : K) : List K → BitProgram K Aux
  ...
  | key :: keys => .seq (copy out tmp keys) (Lax979537Proofs.StackCopy.copy key out tmp)
...
theorem copy_executes (out tmp : K) (hot : out ≠ tmp) (keys : List K)
  ...
  | cons key keys ih =>
    ...
    have h1 := ih hr
    have h2 := Lax979537Proofs.StackCopy.copy_store key out tmp hk.1 hk.2 hot
...
end Lax678846Proofs.StackConcat
