...
namespace Lax678846Proofs.BooleanWitnesses
...
theorem lfp_exists_iff {σ : Vocabulary} {k : Nat} (body : RawFormula σ k [k])
    ...
    (∃ R : Interpretation [(k + 1) + k] A.size,
      ...
      eval query A Fin.elim0
        (Fin.cons (Lax979537.LeastFixedPoints.leastFixedPoint (StageFormulas.operator body A))
          (fun r => Fin.elim0 r)) :=
...
end Lax678846Proofs.BooleanWitnesses
