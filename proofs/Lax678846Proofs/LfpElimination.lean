...
namespace Lax678846Proofs.LfpElimination
...
theorem noFixedPoints {σ : Vocabulary} {k : Nat} (body : RawFormula σ k [k])
  ...
  exact ⟨noFixedPoints_of_firstOrder _ (Lax979537Proofs.ClockLast.firstOrder id),
...
theorem eval_readLast {σ : Vocabulary} {k : Nat} (query : RawFormula σ 0 [k])
  ...
  simpa only [Function.comp_id, hempty] using
    and_congr (Lax979537Proofs.ClockLast.eval_formula id A t η) hs
...
end Lax678846Proofs.LfpElimination
