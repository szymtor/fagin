...
namespace Lax678846Proofs.OrderedDefinitions
...
theorem remove_order {σ : Vocabulary} (Q : Property σ) (hQ : IsomorphismInvariant Q)
    (h : Definable Q) : Lax678846.ExistentialSecondOrder.Definable Q := by
  obtain ⟨τ, φ, hφ, hc⟩ := h
...
theorem of_machine {σ : Vocabulary} (Q : Property σ) {f : List Bool → Bool}
  ...
  apply of_above Q (Lax979537Proofs.TraceCodes.threshold h.tm σ 0) φ
...
end Lax678846Proofs.OrderedDefinitions
