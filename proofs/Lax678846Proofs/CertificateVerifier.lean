...
namespace Lax678846Proofs.CertificateVerifier
...
theorem inNP_of_computable {σ : Vocabulary} (φ : Sentence σ)
    (h : Nonempty (Turing.TM2ComputableInPolyTime
      Lax678846.NondeterministicPolynomialTime.encodePair (fun b => [b]) (verify φ))) :
    Lax678846.NondeterministicPolynomialTime.InNP (fun A => Satisfies A φ) :=
  ⟨verify φ, InputSize.tablePolynomial φ.witnesses, h, language_iff φ⟩

end Lax678846Proofs.CertificateVerifier
