# Registered final submission — lax-988886
...
- Registered and citable: https://laxarchive.org/lax-988886/
- Frozen source: `333e9cbdbd8a389561da30908cabf36051048a13` on `lean-4.33`.
...
- Full local exact-pin Lax compilation, independent kernel replay, and statement
  inspection passed: 4 concepts and 4 proofs; every proof has no non-background assumptions.
...
- Evidence: `../migration-tools/finalize-second-tier-verification.log` and
  `../migration-tools/finalize-fagin-build.log`, `-submit.log`, `-register.log`.
...
Published: https://laxarchive.org/lax-988886/ (archive issue 112).
Commit: 0041a52c8a214b7d3a87b412c71450dd08f7adff.
Archive rebuild passed in 3m45s; public record written in 34s.
...
Created 2026-09-09 in `fagin`, local Lax ID `lax-988886`.
...
- `Lax988886Proofs.Fagin.definableInNP`
- `Lax988886Proofs.Fagin.npDefinable`
- `Lax988886Proofs.Fagin.capturesNP`
...
The refreshed preview at <http://localhost:8126/lax-988886/index.html> was
...
The full annotated theorem `Lax988886Proofs.Fagin.definableInNP` now
...
http://localhost:8126/lax-988886/index.html. The index was fetched successfully
...
All new modules compile together (`lake build Lax988886Proofs`, 1363 jobs).
